    ...
    try {
      ...
      const response = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are an expert insurance claim adjuster and legal writer specializing in construction and storm damage claims. Generate professional dispute letters with strong supporting evidence."
          },
          {
            role: "user",
            content: prompt
