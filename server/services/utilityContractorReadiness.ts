...
export const KENTUCKY_EMCS: StateEMC[] = [
  { name: "Big Sandy Rural Electric Cooperative", website: "https://www.bigsandyrecc.com", type: "emc", state: "KY", description: "Serves Big Sandy region in eastern Kentucky", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Blue Grass Energy Cooperative", website: "https://www.bgenergy.com", type: "emc", state: "KY", description: "Serves central Kentucky Bluegrass region — one of the larger KY cooperatives", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Clark Energy Cooperative", website: "https://www.clarkenergy.com", type: "emc", state: "KY", description: "Serves east-central Kentucky Clark County area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Cumberland Valley Electric", website: "https://www.cvalley.com", type: "emc", state: "KY", description: "Serves southeastern Kentucky Cumberland Valley", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Farmers Rural Electric Cooperative (RECC)", website: "https://www.farmersrecc.com", type: "emc", state: "KY", description: "Serves central Kentucky farming communities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Fleming-Mason Energy Cooperative", website: "https://www.fme.coop", type: "emc", state: "KY", description: "Serves northeast Kentucky Fleming/Mason County area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Grayson Rural Electric Cooperative (RECC)", website: "https://www.graysonrecc.com", type: "emc", state: "KY", description: "Serves northeast Kentucky Grayson area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Green River Electric Corporation", website: "https://www.greenriverelectric.com", type: "emc", state: "KY", description: "Serves western Kentucky Green River region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Inter-County Energy Cooperative", website: "https://www.intercountyenergy.net", type: "emc", state: "KY", description: "Serves central Kentucky communities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Jackson Energy Cooperative", website: "https://www.jacksonenergy.com", type: "emc", state: "KY", description: "Serves southeastern Kentucky — Appalachian region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Kenergy Corp", website: "https://www.kenergycorp.com", type: "emc", state: "KY", description: "Serves western Kentucky — one of the largest KY cooperatives", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission"] },
  { name: "Licking Valley Rural Electric Cooperative (RECC)", website: "https://www.lvrecc.com", type: "emc", state: "KY", description: "Serves northeastern Kentucky Licking Valley", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Meade County Rural Electric Cooperative (RECC)", website: "https://www.meadecountyrec.com", type: "emc", state: "KY", description: "Serves north-central Kentucky Meade County area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Nolin Rural Electric Cooperative (RECC)", website: "https://www.nolinrecc.com", type: "emc", state: "KY", description: "Serves central Kentucky Nolin region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Owen Electric Cooperative", website: "https://www.owenelectric.com", type: "emc", state: "KY", description: "Serves northern Kentucky Owen County area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Pennyrile Rural Electric Cooperative", website: "https://www.pennyrileelectric.com", type: "emc", state: "KY", description: "Serves western Kentucky Pennyrile region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Salt River Electric Cooperative", website: "https://www.saltriverelectric.com", type: "emc", state: "KY", description: "Serves central Kentucky Salt River area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Shelby Energy Cooperative", website: "https://www.shelbyenergy.com", type: "emc", state: "KY", description: "Serves north-central Kentucky Shelby County area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "South Kentucky Rural Electric Cooperative (RECC)", website: "https://www.skrecc.com", type: "emc", state: "KY", description: "Serves south-central Kentucky", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Taylor County Rural Electric Cooperative (RECC)", website: "https://www.tcrecc.com", type: "emc", state: "KY", description: "Serves central Kentucky Taylor County area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Equipment rentals"] },
  { name: "Warren Rural Electric Cooperative (RECC)", website: "https://www.wrecc.com", type: "emc", state: "KY", description: "Serves south-central Kentucky Warren County/Bowling Green area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "West Kentucky Rural Electric Cooperative (RECC)", website: "https://www.wkrecc.com", type: "emc", state: "KY", description: "Serves far western Kentucky — Purchase region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Bowling Green Municipal Utilities (BGMU)", website: "https://www.bgmu.com", type: "emc", state: "KY", description: "Municipal utility serving Bowling Green — south-central Kentucky", serviceTypes: ["Vegetation/ROW clearing", "Emergency restoration", "Distribution maintenance"] },
  { name: "Glasgow Electric Plant Board", website: "https://www.glasgow-ky.com/epb", type: "emc", state: "KY", description: "Municipal utility serving Glasgow in south-central Kentucky", serviceTypes: ["Vegetation/ROW clearing", "Emergency restoration", "Distribution maintenance"] },
  { name: "Owensboro Municipal Utilities (OMU)", website: "https://www.omu.org", type: "emc", state: "KY", description: "Municipal utility serving Owensboro in western Kentucky", serviceTypes: ["Vegetation/ROW clearing", "Emergency restoration", "Distribution maintenance"] },
  { name: "Paducah Power System", website: "https://www.paducahpower.com", type: "emc", state: "KY", description: "Municipal utility serving Paducah in far western Kentucky", serviceTypes: ["Vegetation/ROW clearing", "Emergency restoration", "Distribution maintenance"] },
  { name: "Louisville Gas & Electric / Kentucky Utilities (LG&E-KU)", website: "https://lge-ku.com/suppliers", type: "support_org", state: "KY", description: "Largest IOUs in Kentucky — shared supplier portal. LG&E serves central KY, KU serves the rest of the state. PPL subsidiary.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Kentucky Power (AEP)", website: "https://www.kentuckypower.com", type: "support_org", state: "KY", description: "AEP subsidiary serving eastern Kentucky — Appalachian region. Formal supplier registration through AEP portal.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction"] },
  { name: "Duke Energy Kentucky", website: "https://www.duke-energy.com/partner-with-us/suppliers", type: "support_org", state: "KY", description: "Serves northern Kentucky near Cincinnati metro — supplier registration through Duke Energy portal.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction"] },
  { name: "East Kentucky Power Cooperative (EKPC)", website: "https://www.ekpc.coop", type: "support_org", state: "KY", description: "Generation & transmission cooperative providing wholesale power to 16 Kentucky distribution cooperatives. Major vegetation and transmission contractor opportunities.", serviceTypes: ["Generation support", "Transmission construction", "Vegetation management", "ROW clearing", "Storm restoration"] },
  { name: "Tennessee Valley Authority (TVA) — Kentucky", website: "https://www.tva.com", type: "support_org", state: "KY", description: "Federal utility serving parts of western Kentucky — major vegetation management and transmission contractor opportunities.", serviceTypes: ["Transmission construction", "Vegetation management", "ROW clearing", "Federal utility work"] },
  { name: "Kentucky Association of Electric Cooperatives (KAEC)", website: "https://www.kaec.org", type: "support_org", state: "KY", description: "Statewide association representing all Kentucky electric cooperatives — industry networking, training, vendor contacts.", serviceTypes: ["Cooperative directory", "Industry networking", "Vendor opportunities", "Training programs"] },
];

export const LOUISIANA_EMCS: StateEMC[] = [
  { name: "Allen Parish Electric Cooperative", website: "https://www.apec.info", type: "emc", state: "LA", description: "Serves Allen Parish area in western Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Beauregard Electric Cooperative", website: "https://www.beci.org", type: "emc", state: "LA", description: "Serves Beauregard Parish in southwestern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Claiborne Electric Cooperative", website: "https://cecbridge.org", type: "emc", state: "LA", description: "Serves Claiborne Parish in northwestern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Concordia Electric Cooperative", website: "https://www.concordiaelectric.com", type: "emc", state: "LA", description: "Serves Concordia Parish in northeastern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Dixie Electric Membership Corp", website: "https://www.demco.org", type: "emc", state: "LA", description: "Largest cooperative in Louisiana — serves greater Baton Rouge area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Jeff Davis Electric Cooperative", website: "https://www.jdec.org", type: "emc", state: "LA", description: "Serves Jeff Davis Parish in southwestern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Pointe Coupee Electric Membership Corp", website: "https://pcelec.org", type: "emc", state: "LA", description: "Serves Pointe Coupee area along the Mississippi River", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "South Louisiana Electric Cooperative (SLECA)", website: "https://www.sleca.com", type: "emc", state: "LA", description: "Serves Lafourche and Terrebonne parishes in coastal Louisiana — hurricane corridor", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Southwestern Electric Power Cooperative", website: "https://www.swepco.com", type: "emc", state: "LA", description: "Serves northwest Louisiana — part of Southwestern Electric Power Association", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Valley Electric Membership Corp", website: "https://www.valleyemc.com", type: "emc", state: "LA", description: "Serves northeast Louisiana rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Washington-St. Tammany Electric Cooperative", website: "https://www.wste.coop", type: "emc", state: "LA", description: "Serves Washington and St. Tammany parishes in southeastern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Northeast Louisiana Power Cooperative (NELPCO)", website: "https://www.nelpco.com", type: "emc", state: "LA", description: "G&T cooperative serving northeast Louisiana distribution cooperatives", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "SLEMCO (Southwest Louisiana Electric Membership Corp)", website: "https://www.slemco.com", type: "emc", state: "LA", description: "Serves Acadiana/Lafayette region in southwestern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cajun Electric Power Cooperative", website: "https://www.cajunelectric.com", type: "emc", state: "LA", description: "G&T cooperative serving Louisiana distribution cooperatives", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Entergy New Orleans", website: "https://www.entergy-neworleans.com", type: "emc", state: "LA", description: "Municipal utility serving New Orleans metro area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Lafayette Utilities System", website: "https://www.lus.org", type: "emc", state: "LA", description: "Municipal utility serving Lafayette and surrounding area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Plaquemine Public Power Authority", website: "https://www.plaqueminepower.com", type: "emc", state: "LA", description: "Municipal utility serving Plaquemine area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Ruston Utilities", website: "https://www.ruston.org", type: "emc", state: "LA", description: "Municipal utility serving Ruston in northern Louisiana", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Entergy Louisiana", website: "https://www.entergy.com/suppliers/", type: "support_org", state: "LA", description: "Largest utility in Louisiana serving most of the state — Entergy subsidiary. Supplier portal for contractor registration.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Cleco Power", website: "https://www.cleco.com/my-community/suppliers/", type: "support_org", state: "LA", description: "Major electric utility in central and southwestern Louisiana — supplier registration portal", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "SWEPCO (AEP)", website: "https://www.swepco.com/aboutswepco/procurement/", type: "support_org", state: "LA", description: "AEP subsidiary serving northwest Louisiana — formal procurement portal", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Association of Louisiana Electric Cooperatives (ALEC)", website: "https://www.alec.coop", type: "support_org", state: "LA", description: "Statewide association representing Louisiana electric cooperatives — industry networking and vendor opportunities", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Emergency response", "Cooperative directory"] },
];

export const MAINE_EMCS: StateEMC[] = [
  { name: "Eastern Maine Electric Cooperative", website: "https://www.emec.com", type: "emc", state: "ME", description: "Serves eastern Maine rural areas — nor'easter and ice storm exposure", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Fox Islands Electric Cooperative", website: "https://foxislandselectric.coop", type: "emc", state: "ME", description: "Serves Vinalhaven and North Haven islands off Maine coast", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Kennebunk Light & Power District", website: "https://www.klpd.org", type: "emc", state: "ME", description: "Municipal utility serving Kennebunk in southern Maine coastal area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Madison Electric Works", website: "https://www.madisonelectricworks.com", type: "emc", state: "ME", description: "Municipal utility serving Madison in central Maine", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Van Buren Light & Power District", website: "https://www.vanburenme.org", type: "emc", state: "ME", description: "Municipal utility in northern Maine border area — extreme weather exposure", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Houlton Water Company (Electric Division)", website: "https://www.houltonwater.com", type: "emc", state: "ME", description: "Municipal utility serving Houlton in northeastern Maine", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "City of Presque Isle Electric Utility", website: "https://www.presqueisleme.us", type: "emc", state: "ME", description: "Municipal utility in Aroostook County in far northern Maine", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Maine Public Utilities Commission (MPUC)", website: "https://www.maine.gov/mpuc", type: "emc", state: "ME", description: "Statewide regulatory resource for Maine electric utilities — vendor coordination", serviceTypes: ["Regulatory coordination", "Industry standards", "Vendor resources", "Utility liaison"] },
  { name: "Central Maine Power (CMP)", website: "https://www.cmpco.com/suppliers", type: "support_org", state: "ME", description: "Largest electric utility in Maine — supplier portal for contractor registration", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Versant Power", website: "https://versantpower.com/business/doing-business-with-us/", type: "support_org", state: "ME", description: "Serves northern and eastern Maine — formal procurement and supplier portal", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const MARYLAND_EMCS: StateEMC[] = [
  { name: "SMECO (Southern Maryland Electric Cooperative)", website: "https://www.smeco.coop/AboutUs/Business", type: "emc", state: "MD", description: "Largest Maryland electric cooperative — serves southern Maryland counties", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Choptank Electric Cooperative", website: "https://www.choptankelectric.coop/about-us", type: "emc", state: "MD", description: "Serves Eastern Shore of Maryland — coastal hurricane exposure", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "A&N Electric Cooperative", website: "https://www.anec.com", type: "emc", state: "MD", description: "Serves Worcester County on the Delmarva Peninsula (shared with Virginia)", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "City of Annapolis Utilities", website: "https://www.annapolis.gov", type: "emc", state: "MD", description: "Municipal utility serving Annapolis — Chesapeake Bay area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "City of Berlin Utilities", website: "https://townofberlin.net", type: "emc", state: "MD", description: "Municipal utility serving Berlin on the Eastern Shore", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Easton Utilities", website: "https://www.eastonutilities.com", type: "emc", state: "MD", description: "Municipal utility serving Easton on the Eastern Shore — Chesapeake Bay region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Hagerstown Light Department", website: "https://www.hagerstownmd.org", type: "emc", state: "MD", description: "Municipal utility serving Hagerstown in western Maryland", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Thurmont Municipal Light", website: "https://www.thurmont.com", type: "emc", state: "MD", description: "Municipal utility serving Thurmont in western Maryland mountains", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Baltimore Gas & Electric (BGE)", website: "https://www.bge.com/Pages/DoingBusinessWithBGE.aspx", type: "support_org", state: "MD", description: "Major IOU in Baltimore metro area — Exelon subsidiary. Formal supplier registration and procurement portal.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Potomac Electric Power (Pepco)", website: "https://www.pepco.com/suppliers", type: "support_org", state: "MD", description: "Serves suburban DC/Maryland area — Exelon subsidiary. Supplier portal for contractor registration.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Delmarva Power", website: "https://www.delmarva.com/about/about-us/suppliers", type: "support_org", state: "MD", description: "Serves Delmarva Peninsula region (Maryland, Delaware, Virginia) — Exelon subsidiary", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Maryland eProcurement System (MEPS)", website: "https://procurement.maryland.gov", type: "support_org", state: "MD", description: "Statewide vendor registration and procurement system for Maryland utilities and government", serviceTypes: ["Statewide procurement", "Vendor registration", "Government contracts", "Utility coordination"] },
];

export const MASSACHUSETTS_EMCS: StateEMC[] = [
  { name: "Holyoke Gas & Electric (HG&E)", website: "https://www.hged.com/about-us/procurement", type: "emc", state: "MA", description: "Municipal utility with procurement opportunities in western Massachusetts", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Reading Municipal Light Department (RMLD)", website: "https://www.rmld.com/procurement", type: "emc", state: "MA", description: "Municipal utility serving Reading in greater Boston area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Braintree Electric Light Department (BELD)", website: "https://www.beld.com/about-us/procurement", type: "emc", state: "MA", description: "Municipal utility serving Braintree in the Boston metro region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Middleborough Gas & Electric (MGED)", website: "https://www.mged.com/about-us", type: "emc", state: "MA", description: "Municipal utility serving Middleborough in southeastern Massachusetts", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Taunton Municipal Lighting Plant (TMLP)", website: "https://www.tmlp.com/about-us", type: "emc", state: "MA", description: "Municipal utility serving Taunton in southeastern Massachusetts", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Concord Municipal Light Plant", website: "https://www.concordma.gov/287/Municipal-Light-Plant", type: "emc", state: "MA", description: "Municipal utility serving Concord in central Massachusetts", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wellesley Municipal Light Plant", website: "https://www.wellesleyma.gov/330/Municipal-Light-Plant", type: "emc", state: "MA", description: "Municipal utility serving Wellesley in greater Boston area", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Peabody Municipal Light Plant", website: "https://www.peabodymunicipallightplant.com", type: "emc", state: "MA", description: "Municipal utility serving Peabody in the Boston metro region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Shrewsbury Electric & Cable Operations", website: "https://www.shrewsbury-ma.gov/seco", type: "emc", state: "MA", description: "Municipal utility serving Shrewsbury in central Massachusetts", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Chicopee Electric Light", website: "https://www.celd.com", type: "emc", state: "MA", description: "Municipal utility serving Chicopee in western Massachusetts", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Eversource Energy (MA)", website: "https://www.eversource.com/content/general/about/corporate/suppliers", type: "support_org", state: "MA", description: "Largest utility in Massachusetts — serves most of the state. Formal supplier registration and procurement portal.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "National Grid (MA)", website: "https://www.nationalgridus.com/MA-Home/Doing-Business", type: "support_org", state: "MA", description: "Major utility in Massachusetts serving metro Boston and central regions — supplier procurement opportunities", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Unitil (MA)", website: "https://www.unitil.com/about-us/suppliers", type: "support_org", state: "MA", description: "Regional utility serving Massachusetts and New Hampshire — contractor registration and vendor portal", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "COMMBUYS (State procurement)", website: "https://www.commbuys.com", type: "support_org", state: "MA", description: "Statewide vendor registration and procurement system for Massachusetts utilities and government agencies", serviceTypes: ["Statewide procurement", "Vendor registration", "Government contracts", "Utility coordination"] },
];

export const MICHIGAN_EMCS: StateEMC[] = [
  { name: "Great Lakes Energy Cooperative", website: "https://www.gtlec.coop", type: "emc", state: "MI", description: "One of the largest electric cooperatives in Michigan serving central Michigan", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "HomeWorks Tri-County Electric Cooperative", website: "https://www.homeworks.org", type: "emc", state: "MI", description: "Central Michigan cooperative serving multiple counties with storm restoration opportunities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cloverland Electric Cooperative", website: "https://www.cloverland.com", type: "emc", state: "MI", description: "Serves Upper Peninsula of Michigan — harsh winter conditions and ice storm exposure", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cherryland Electric Cooperative", website: "https://www.cherrylandelectric.coop", type: "emc", state: "MI", description: "Northwest Michigan cooperative serving the cherry country region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Midwest Energy & Communications", website: "https://www.mec.coop", type: "emc", state: "MI", description: "Southwest Michigan cooperative providing electrical service and contractor opportunities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Ontonagon County REMC", website: "https://www.ontonagonremc.com", type: "emc", state: "MI", description: "Upper Peninsula cooperative serving remote communities with extreme winter conditions", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wolverine Power Cooperative (G&T)", website: "https://www.wolverinepowercooperative.org", type: "emc", state: "MI", description: "Generation and transmission cooperative serving Michigan's electric cooperatives", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Lansing Board of Water & Light (BWL)", website: "https://www.lbwl.com/business/contractor-opportunities", type: "emc", state: "MI", description: "Major municipal utility serving Lansing with dedicated contractor opportunities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Holland Board of Public Works", website: "https://www.hollandbpw.com/business/contractor-information", type: "emc", state: "MI", description: "Municipal utility serving Holland in western Michigan near Lake Michigan", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Grand Haven Board of Light & Power", website: "https://www.gnb.org/department/board-of-light-and-power", type: "emc", state: "MI", description: "Municipal utility serving Grand Haven on the Lake Michigan shore", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Marquette Board of Light & Power", website: "https://marquetteblp.com", type: "emc", state: "MI", description: "Municipal utility serving Marquette in Michigan's Upper Peninsula", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Traverse City Light & Power", website: "https://www.tclp.org", type: "emc", state: "MI", description: "Municipal utility serving Traverse City in northern Michigan", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "DTE Energy", website: "https://corporate.dteenergy.com/business-with-us/suppliers", type: "support_org", state: "MI", description: "Largest utility in Michigan — serves Detroit metro and much of the state. Formal supplier registration and procurement portal.", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Consumers Energy", website: "https://www.consumersenergy.com/company/suppliers", type: "support_org", state: "MI", description: "Major utility in Michigan serving central and western regions — comprehensive contractor registration program", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Upper Peninsula Power Company (UPPCO)", website: "https://www.uppco.com/about-us/business-opportunities", type: "support_org", state: "MI", description: "Utility serving Michigan's Upper Peninsula — extreme winter storms and ice conditions", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Indiana Michigan Power (AEP)", website: "https://www.indianamichiganpower.com/suppliers", type: "support_org", state: "MI", description: "AEP subsidiary serving portions of Michigan — supplier portal for contractor registration", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Michigan Vendor Portal", website: "https://www.michigan.gov/dtmb/bureau-of-business-opportunity/supplier", type: "support_org", state: "MI", description: "Statewide vendor registration and procurement system for Michigan utilities and government agencies", serviceTypes: ["Statewide procurement", "Vendor registration", "Government contracts", "Utility coordination"] },
];

export const MINNESOTA_EMCS: StateEMC[] = [
  { name: "Connexus Energy", website: "https://www.connexusenergy.com", type: "emc", state: "MN", description: "Largest MN cooperative, serves north metro — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Dakota Electric Association", website: "https://www.dakotaelectric.com", type: "emc", state: "MN", description: "Serves south metro suburbs — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Lake Region Electric Cooperative", website: "https://www.lrec.coop", type: "emc", state: "MN", description: "West-central MN — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Mille Lacs Energy Cooperative", website: "https://www.millelacsenergy.com", type: "emc", state: "MN", description: "Central MN — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Crow Wing Power (now Great River Energy member)", website: "https://www.cwpower.com", type: "emc", state: "MN", description: "North-central MN — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wright-Hennepin Cooperative Electric", website: "https://www.whe.org", type: "emc", state: "MN", description: "West metro area — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Stearns Electric Association", website: "https://www.stearnselectric.org", type: "emc", state: "MN", description: "Central MN — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Itasca-Mantrap Cooperative Electric", website: "https://www.itasca-mantrap.com", type: "emc", state: "MN", description: "North-central MN — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Kandiyohi Power Cooperative", website: "https://www.kfrec.com", type: "emc", state: "MN", description: "West-central MN — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Runestone Electric Association", website: "https://www.runestoneelectric.com", type: "emc", state: "MN", description: "Alexandria area — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Austin Utilities", website: "https://www.austinutilities.com", type: "emc", state: "MN", description: "Municipal utility — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Rochester Public Utilities", website: "https://www.rpu.org", type: "emc", state: "MN", description: "Major municipal utility — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Moorhead Public Service", website: "https://www.mpsutility.com", type: "emc", state: "MN", description: "Municipal, Fargo-Moorhead area — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Great River Energy (G&T)", website: "https://www.greatriverenergy.com", type: "support_org", state: "MN", description: "G&T wholesale cooperative for 28 MN distribution co-ops — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Xcel Energy (MN)", website: "https://www.xcelenergy.com/working_with_us/suppliers", type: "support_org", state: "MN", description: "Largest MN utility — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Minnesota Power", website: "https://www.mnpower.com/AboutUs/Suppliers", type: "support_org", state: "MN", description: "Serves northern MN, ALLETE subsidiary — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Otter Tail Power Company", website: "https://www.otpco.com/business/suppliers", type: "support_org", state: "MN", description: "Serves western MN/ND — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Minnesota Rural Electric Association (MREA)", website: "https://www.mrea.org", type: "support_org", state: "MN", description: "Statewide cooperative association — blizzards, ice storms, severe thunderstorms/tornadoes, extreme cold", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const MISSISSIPPI_EMCS: StateEMC[] = [
  { name: "Coast Electric Power Association", website: "https://www.coastepa.com", type: "emc", state: "MS", description: "Gulf Coast area — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Singing River Electric", website: "https://www.singingriver.com", type: "emc", state: "MS", description: "Southeast MS/Gulf Coast — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Dixie Electric Power Association", website: "https://www.dixieepa.com", type: "emc", state: "MS", description: "Central MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Magnolia Electric Power Association", website: "https://www.magnoliaelectric.com", type: "emc", state: "MS", description: "Southwest MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Central Electric Power Association", website: "https://www.centralelectric.ms", type: "emc", state: "MS", description: "Central MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Tallahatchie Valley Electric Power Assoc", website: "https://www.tvepa.com", type: "emc", state: "MS", description: "North-central MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "North East Mississippi Electric Power Assoc", website: "https://www.nemepa.com", type: "emc", state: "MS", description: "Northeast MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Coahoma Electric Power Association", website: "https://www.coahomaepa.com", type: "emc", state: "MS", description: "Northwest MS Delta — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Southwest Mississippi Electric Power Assoc", website: "https://www.swepa.com", type: "emc", state: "MS", description: "Southwest MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Pearl River Valley Electric Power Assoc", website: "https://www.prvepa.com", type: "emc", state: "MS", description: "South-central MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Yazoo Valley Electric Power Association", website: "https://www.yazoo.coop", type: "emc", state: "MS", description: "Central MS/Delta — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Starkville Utilities", website: "https://www.cityofstarkville.org", type: "emc", state: "MS", description: "Municipal, MSU area — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Entergy Mississippi", website: "https://www.entergy.com/suppliers/", type: "support_org", state: "MS", description: "Largest MS utility — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Mississippi Power (Southern Company)", website: "https://www.mississippipower.com/suppliers", type: "support_org", state: "MS", description: "Serves southeast MS — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Mississippi Electric Cooperatives Association", website: "https://www.mecaonline.com", type: "support_org", state: "MS", description: "State cooperative association — hurricanes, tornadoes, severe storms, Gulf Coast flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const MISSOURI_EMCS: StateEMC[] = [
  { name: "Co-Mo Electric Cooperative", website: "https://www.co-mo.coop", type: "emc", state: "MO", description: "Central MO — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Ozark Border Electric Cooperative", website: "https://www.ozarkborderelectric.com", type: "emc", state: "MO", description: "South-central MO — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Sho-Me Power Electric Cooperative (G&T)", website: "https://www.shomepower.com", type: "emc", state: "MO", description: "G&T serving southern MO co-ops — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "White River Valley Electric Cooperative", website: "https://www.whiterivervalley.com", type: "emc", state: "MO", description: "SW MO/Branson area — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Black River Electric Cooperative", website: "https://www.blackriverelectric.com", type: "emc", state: "MO", description: "Southeast MO — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Laclede Electric Cooperative", website: "https://www.lacledeelectric.com", type: "emc", state: "MO", description: "Central MO/Ozarks — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Boone Electric Cooperative", website: "https://www.booneelectric.com", type: "emc", state: "MO", description: "Columbia/Boone County area — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cuivre River Electric Cooperative", website: "https://www.cuivreriverelectric.com", type: "emc", state: "MO", description: "NE of St. Louis — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Three Rivers Electric Cooperative", website: "https://www.threeriverselectric.com", type: "emc", state: "MO", description: "Central MO — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Platte-Clay Electric Cooperative", website: "https://www.platteclay.com", type: "emc", state: "MO", description: "North of Kansas City — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Citizens Electric Corporation", website: "https://www.citizenselectric.com", type: "emc", state: "MO", description: "SE MO/Perryville area — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Springfield City Utilities", website: "https://www.cityutilities.net", type: "emc", state: "MO", description: "Major municipal utility — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Columbia Water & Light", website: "https://www.como.gov/water-and-light", type: "emc", state: "MO", description: "Municipal utility — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Independence Power & Light", website: "https://www.ci.independence.mo.us/pw", type: "emc", state: "MO", description: "Municipal near KC — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Ameren Missouri", website: "https://www.ameren.com/missouri/company/procurement", type: "support_org", state: "MO", description: "Largest MO utility, St. Louis area — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Evergy (KCP&L) Missouri", website: "https://www.evergy.com/manage-account/manage-business", type: "support_org", state: "MO", description: "Kansas City area — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Empire District Electric (Liberty Utilities)", website: "https://www.libertyutilities.com", type: "support_org", state: "MO", description: "Southwest MO — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Association of Missouri Electric Cooperatives (AMEC)", website: "https://www.amec.org", type: "support_org", state: "MO", description: "State cooperative association — Tornado Alley, severe storms, ice storms, Mississippi/Missouri River flooding", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const MONTANA_EMCS: StateEMC[] = [
  { name: "Flathead Electric Cooperative", website: "https://www.flatheadelectric.com", type: "emc", state: "MT", description: "Largest MT cooperative, Kalispell area — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Ravalli Electric Cooperative", website: "https://www.ravallielectric.com", type: "emc", state: "MT", description: "Hamilton/Bitterroot Valley — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Missoula Electric Cooperative", website: "https://www.missoulaelectric.com", type: "emc", state: "MT", description: "Missoula area — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Vigilante Electric Cooperative", website: "https://www.vec.coop", type: "emc", state: "MT", description: "SW Montana/Dillon area — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Glacier Electric Cooperative", website: "https://www.glacierelectric.com", type: "emc", state: "MT", description: "Glacier County/Cut Bank area — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Sun River Electric Cooperative", website: "https://www.sunriverelectric.coop", type: "emc", state: "MT", description: "Great Falls area — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Fergus Electric Cooperative", website: "https://www.ferguselectric.coop", type: "emc", state: "MT", description: "Central MT/Lewistown — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Hill County Electric Cooperative", website: "https://www.hillcountyelectric.coop", type: "emc", state: "MT", description: "Havre/north-central MT — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Tongue River Electric Cooperative", website: "https://www.tongueriverelectric.coop", type: "emc", state: "MT", description: "SE Montana — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Yellowstone Valley Electric Cooperative", website: "https://www.yvec.com", type: "emc", state: "MT", description: "Huntley/south-central MT — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Butte Municipal Electric Utility", website: "https://www.buttemt.org", type: "emc", state: "MT", description: "Municipal serving Butte — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "NorthWestern Energy", website: "https://www.northwesternenergy.com/suppliers", type: "support_org", state: "MT", description: "Largest MT utility — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Montana-Dakota Utilities (MDU)", website: "https://www.montana-dakota.com", type: "support_org", state: "MT", description: "Serves eastern MT — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Montana Electric Cooperatives' Association (MECA)", website: "https://www.mtco-ops.com", type: "support_org", state: "MT", description: "State cooperative association — extreme winter storms, wildfires, mountain terrain, high winds, remote/rural areas", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NEBRASKA_EMCS: StateEMC[] = [
  { name: "Omaha Public Power District (OPPD)", website: "https://www.oppd.com/suppliers/", type: "emc", state: "NE", description: "Omaha's major public power utility — centralized procurement, vendor registration, supplier diversity, contractor opportunities for construction, vegetation/ROW, storm restoration", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Nebraska Public Power District (NPPD)", website: "https://www.nppd.com/business/business-with-nppd/", type: "emc", state: "NE", description: "Statewide public power utility with generation, transmission & distribution — supplier registration, bid opportunities, procurement contact information", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Lincoln Electric System (LES)", website: "https://www.les.com/doing-business-with-les/", type: "emc", state: "NE", description: "Lincoln's public power municipal utility — vendor registration, current RFPs/bid opportunities, supplier guidance and policy", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Black Hills Energy – Nebraska", website: "https://www.blackhillsenergy.com/suppliers", type: "emc", state: "NE", description: "Investor-owned utility serving parts of Nebraska — vendor registration and purchasing info for storm response and utility work", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Central Nebraska Public Power & Irrigation District", website: "https://www.cnppid.com", type: "emc", state: "NE", description: "Central NE public power & irrigation district — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cornhusker Public Power District", website: "https://www.cornhuskerpublicpower.com", type: "emc", state: "NE", description: "NE/Columbus area public power district — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Dundy County Public Power District", website: "https://www.dundy-ppd.com", type: "emc", state: "NE", description: "SW Nebraska public power district — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Hamilton County RPPD", website: "https://www.hamiltoncountyppd.com", type: "emc", state: "NE", description: "Hamilton County rural public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Highland Public Power District", website: "https://www.highlandppd.com", type: "emc", state: "NE", description: "Highland area public power district — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Hastings Utilities", website: "https://www.hastingsutilities.com", type: "emc", state: "NE", description: "Municipal utility serving Hastings — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Kearney RPPD", website: "https://www.kearneyrppd.com", type: "emc", state: "NE", description: "Kearney area rural public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Lower Loup Public Power District", website: "https://www.llppd.com", type: "emc", state: "NE", description: "Lower Loup River valley public power — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Loup River Public Power District", website: "https://www.loup.com", type: "emc", state: "NE", description: "Central NE Loup River area public power — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Nemaha County RPPD", website: "https://www.nemaharppd.com", type: "emc", state: "NE", description: "Nemaha County rural public power district — SE Nebraska, severe thunderstorms, tornado risk", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Niobrara Valley RPPD", website: "https://www.nvppd.com", type: "emc", state: "NE", description: "Niobrara Valley rural public power — N Nebraska, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "North Central Public Power District", website: "https://www.ncppd.com", type: "emc", state: "NE", description: "North central NE public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Platte Valley Public Power & Irrigation District", website: "https://www.plattevalleyppid.com", type: "emc", state: "NE", description: "Platte Valley area public power & irrigation — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Southern Public Power District", website: "https://www.southernpower.com", type: "emc", state: "NE", description: "SE NE/Grand Island area public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Dawson Public Power District", website: "https://www.dawsonpower.com", type: "emc", state: "NE", description: "Central NE public power district — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Norris Public Power District", website: "https://www.norrisppd.com", type: "emc", state: "NE", description: "Southeast NE public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Elkhorn Rural Public Power District", website: "https://www.erppd.com", type: "emc", state: "NE", description: "NE Nebraska rural public power — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cuming County Public Power District", website: "https://www.ccppd.com", type: "emc", state: "NE", description: "NE Nebraska public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Perennial Public Power District", website: "https://www.perennialpower.com", type: "emc", state: "NE", description: "SE Nebraska public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wheat Belt Public Power District", website: "https://www.wheatbelt.com", type: "emc", state: "NE", description: "Panhandle NE public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Twin Valleys Public Power District", website: "https://www.twinvalleysppd.com", type: "emc", state: "NE", description: "South-central NE public power district — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Western Area Power Administration (WAPA) – Upper Great Plains", website: "https://www.wapa.gov/regions/UGP/Pages/UGP.aspx", type: "emc", state: "NE", description: "Federal power marketing administration serving Upper Great Plains region including Nebraska — transmission and wholesale power", serviceTypes: ["Transmission construction", "Vegetation/ROW clearing", "Emergency restoration", "Distribution maintenance"] },
  { name: "Nebraska Rural Electric Association (NREA)", website: "https://www.nrea.org", type: "support_org", state: "NE", description: "State cooperative association — co-ops directory, member links & contacts for all NE cooperatives", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Municipal Energy Agency of Nebraska (MEAN)", website: "https://www.nmppenergy.org", type: "support_org", state: "NE", description: "Joint action agency for 70+ NE municipalities — Tornado Alley, severe thunderstorms, winter blizzards", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "LinkSystems / VendorLink Bid Portal", website: "https://hccvendorregistration.org/common/otheragencysites.aspx", type: "support_org", state: "NE", description: "Cooperative bid portal used by many NE cooperatives & municipal utilities — register as vendor to receive bid alerts", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "State of Nebraska – Procurement Services", website: "https://das.nebraska.gov/purchasing/", type: "support_org", state: "NE", description: "Statewide procurement system — vendor registration, bid opportunities from state agencies including utility-related work", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NEVADA_EMCS: StateEMC[] = [
  { name: "Valley Electric Association", website: "https://www.vea.coop", type: "emc", state: "NV", description: "Largest NV cooperative, Pahrump/Nye County — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wells Rural Electric Company", website: "https://www.wrec.coop", type: "emc", state: "NV", description: "Northeastern NV/Elko area — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Mt. Wheeler Power", website: "https://www.mwpower.net", type: "emc", state: "NV", description: "Eastern NV/Ely area — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Lincoln County Power District", website: "https://www.lcpd1.com", type: "emc", state: "NV", description: "Lincoln County NV — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Overton Power District", website: "https://www.ovpd.com", type: "emc", state: "NV", description: "Moapa Valley/Overton area — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Boulder City Utilities", website: "https://www.bcnv.org", type: "emc", state: "NV", description: "Municipal utility, near Hoover Dam — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "City of Caliente (Electric)", website: "https://www.caliente-nv.com", type: "emc", state: "NV", description: "Municipal in Lincoln County — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "NV Energy", website: "https://www.nvenergy.com/doing-business/supply-chain", type: "support_org", state: "NV", description: "Dominant utility (serves 90% of state), Berkshire Hathaway subsidiary — extreme heat, desert conditions, wind events, flash flooding, remote terrain", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NEW_HAMPSHIRE_EMCS: StateEMC[] = [
  { name: "Eversource Energy (NH)", website: "https://www.eversource.com/content/supplier", type: "emc", state: "NH", description: "Largest NH utility (formerly PSNH) serving 500,000+ customers — nor'easters, ice storms, heavy snow, high winds, coastal flooding. Supplier portal with vendor registration, RFPs, procurement opportunities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Liberty Utilities – NH", website: "https://libertyutilities.com/suppliers", type: "emc", state: "NH", description: "Serves central/southern NH including Keene, Salem, Lebanon — nor'easters, ice storms, heavy snow, high winds. Supplier registration portal available", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "New Hampshire Electric Cooperative (NHEC)", website: "https://www.nhec.com/business-with-nhec", type: "emc", state: "NH", description: "Only electric cooperative in NH, serves 84,000+ members across rural/mountainous areas — nor'easters, ice storms, heavy snow, high winds, remote terrain. Procurement portal for contractor work", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Unitil Energy Systems – NH", website: "https://unitil.com/about-us/business-partners", type: "emc", state: "NH", description: "Serves Capital area (Concord) and Seacoast region — nor'easters, ice storms, heavy snow, high winds, coastal flooding", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Littleton Water & Light Department", website: "https://www.littletonwaterandlight.com", type: "emc", state: "NH", description: "Municipal utility serving Littleton in White Mountains region — nor'easters, ice storms, heavy snow, mountain terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Woodsville Water & Light Department", website: "https://www.woodsvillewaterandlight.com", type: "emc", state: "NH", description: "Municipal utility in northern NH — nor'easters, ice storms, heavy snow, mountain terrain", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Ashland Electric Department", website: "https://www.ashland.nh.gov", type: "emc", state: "NH", description: "Municipal electric serving Ashland — nor'easters, ice storms, heavy snow, Lakes Region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wolfeboro Municipal Electric Department", website: "https://www.wolfeboronh.us", type: "emc", state: "NH", description: "Municipal electric serving Wolfeboro — nor'easters, ice storms, heavy snow, Lakes Region", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "New Hampton Village Precinct Electric", website: "https://www.new-hampton.nh.us", type: "emc", state: "NH", description: "Small municipal electric in central NH — nor'easters, ice storms, heavy snow", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "State of New Hampshire – Online Vendor Registration", website: "https://apps.das.nh.gov/vendorregistration/", type: "support_org", state: "NH", description: "Central state vendor registration portal — obtain vendor code for state purchasing opportunities including utility and public works projects", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "NH Public Utilities Commission (PUC)", website: "https://www.puc.nh.gov", type: "support_org", state: "NH", description: "State regulatory body overseeing electric utilities — filings, utility contacts, regulatory proceedings", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "New England Power Pool (NEPOOL) / ISO New England", website: "https://www.iso-ne.com", type: "support_org", state: "NH", description: "Regional transmission organization managing New England's power grid — transmission projects, grid reliability, wholesale market", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NEW_JERSEY_EMCS: StateEMC[] = [
  { name: "PSE&G (Public Service Electric & Gas)", website: "https://www.pseg.com/suppliers", type: "emc", state: "NJ", description: "Largest NJ utility serving 2.3M+ electric customers — nor'easters, hurricanes, coastal flooding, severe thunderstorms. Supplier portal with vendor registration", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Jersey Central Power & Light (FirstEnergy)", website: "https://www.firstenergycorp.com/suppliers", type: "emc", state: "NJ", description: "Serves central/northern NJ — nor'easters, hurricanes, coastal flooding, severe thunderstorms. FirstEnergy supplier portal for contractor registration", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Atlantic City Electric (Exelon)", website: "https://www.exeloncorp.com/suppliers", type: "emc", state: "NJ", description: "Serves southern NJ/Atlantic City area — nor'easters, hurricanes, coastal flooding, severe thunderstorms. Exelon supplier registration portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "NJ Board of Public Utilities (BPU)", website: "https://www.nj.gov/bpu/", type: "support_org", state: "NJ", description: "State regulatory body overseeing NJ electric utilities — filings, utility contacts, regulatory proceedings", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NEW_MEXICO_EMCS: StateEMC[] = [
  { name: "PNM (Public Service Company of New Mexico)", website: "https://www.pnm.com/suppliers", type: "emc", state: "NM", description: "Largest NM utility serving Albuquerque and Santa Fe — desert heat, wildfires, monsoons, high winds, flash flooding. Supplier registration portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "El Paso Electric (NM service area)", website: "https://www.epelectric.com/company/suppliers", type: "emc", state: "NM", description: "Serves southern NM/Las Cruces area — desert heat, wildfires, monsoons, high winds, flash flooding. Supplier portal available", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Southwestern Public Service (Xcel Energy)", website: "https://www.xcelenergy.com/company/suppliers", type: "emc", state: "NM", description: "Serves eastern NM/Clovis/Roswell area — desert heat, severe thunderstorms, high winds, flash flooding. Xcel Energy supplier portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "New Mexico Electric Cooperatives", website: "https://www.nmelectric.coop", type: "support_org", state: "NM", description: "Statewide cooperative network representing multiple NM electric cooperatives — desert heat, wildfires, monsoons, high winds", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NEW_YORK_EMCS: StateEMC[] = [
  { name: "Con Edison (ConEd)", website: "https://www.coned.com/en/business-partners/suppliers", type: "emc", state: "NY", description: "Serves NYC and Westchester — nor'easters, hurricanes, coastal flooding, heat waves, severe thunderstorms. Supplier portal with vendor registration", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "National Grid – NY", website: "https://www.nationalgridus.com/suppliers", type: "emc", state: "NY", description: "Serves upstate NY, Brooklyn, Queens, Staten Island, Long Island — nor'easters, ice storms, heavy snow, lake effect storms. Supplier registration portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "NYSEG (Avangrid)", website: "https://www.avangrid.com/suppliers", type: "emc", state: "NY", description: "New York State Electric & Gas serving central/upstate NY — nor'easters, ice storms, heavy snow, lake effect storms. Avangrid supplier portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "RG&E (Avangrid)", website: "https://www.avangrid.com/suppliers", type: "emc", state: "NY", description: "Rochester Gas & Electric serving Rochester/Finger Lakes area — nor'easters, ice storms, heavy snow, lake effect storms. Avangrid supplier portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "PSEG Long Island", website: "https://www.psegliny.com/aboutpseglongisland/suppliers", type: "emc", state: "NY", description: "Serves Long Island as public authority — nor'easters, hurricanes, coastal flooding, severe thunderstorms. Supplier info portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "NY Power Authority (NYPA)", website: "https://www.nypa.gov/services/doing-business-with-nypa", type: "support_org", state: "NY", description: "Largest state public power organization in US — transmission projects, hydroelectric, grid reliability", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NORTH_CAROLINA_EMCS: StateEMC[] = [
  { name: "Duke Energy Carolinas", website: "https://www.duke-energy.com/partner-with-us/suppliers", type: "emc", state: "NC", description: "Major IOU serving western/central NC — hurricanes, severe thunderstorms, ice storms, tornadoes. Duke Energy supplier portal for vendor registration", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Duke Energy Progress", website: "https://www.duke-energy.com/partner-with-us/suppliers", type: "emc", state: "NC", description: "Serves eastern NC including Raleigh area — hurricanes, severe thunderstorms, ice storms, coastal flooding. Duke Energy supplier portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Dominion Energy NC", website: "https://www.dominionenergy.com/suppliers", type: "emc", state: "NC", description: "Serves northeastern NC/Outer Banks area — hurricanes, severe thunderstorms, coastal flooding, nor'easters. Dominion supplier registration portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Electric Cooperatives of North Carolina (26 co-ops)", website: "https://www.ncelectriccooperatives.com/our-organization/business-opportunities", type: "support_org", state: "NC", description: "Statewide association of 26 electric cooperatives — business opportunities portal, vendor info for all NC co-ops", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const NORTH_DAKOTA_EMCS: StateEMC[] = [
  { name: "Montana-Dakota Utilities (MDU)", website: "https://www.montana-dakota.com/suppliers", type: "emc", state: "ND", description: "Serves western ND including Bismarck/Dickinson — extreme winter storms, blizzards, high winds, Tornado Alley. MDU supplier info portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Otter Tail Power", website: "https://www.otpco.com/suppliers", type: "emc", state: "ND", description: "Serves eastern ND including Fargo area — extreme winter storms, blizzards, high winds, severe thunderstorms. Supplier portal for contractor registration", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Xcel Energy – ND (Northern States Power)", website: "https://www.xcelenergy.com/company/suppliers", type: "emc", state: "ND", description: "Serves Fargo/Minot areas — extreme winter storms, blizzards, high winds, severe thunderstorms. Xcel Energy supplier portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Basin Electric Power Cooperative", website: "https://www.basinelectric.com", type: "emc", state: "ND", description: "Major G&T cooperative headquartered in Bismarck serving 9 states — generation, transmission, wholesale power", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "North Dakota Association of Rural Electric Cooperatives", website: "https://www.ndarec.com", type: "support_org", state: "ND", description: "Statewide cooperative association representing ND rural electric cooperatives — directory, member contacts, joint procurement", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];

export const TEXAS_EMCS: StateEMC[] = [
  { name: "Oncor Electric Delivery", website: "https://www.oncor.com/en-us/suppliers", type: "emc", state: "TX", description: "Major T&D utility serving large portions of North and Central Texas — hurricanes, severe thunderstorms, tornadoes, extreme heat, ice storms. Supplier registration with prequalification required", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "CenterPoint Energy (Electric)", website: "https://www.centerpointenergy.com/en-us/corporate/suppliers", type: "emc", state: "TX", description: "Serves Houston metro area as T&D utility — hurricanes, severe thunderstorms, flooding, extreme heat. Supplier registration and diversity requirements", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "AEP Texas", website: "https://www.aep.com/suppliers", type: "emc", state: "TX", description: "Serves large areas of South and West Texas — hurricanes, severe thunderstorms, extreme heat, desert conditions. Centralized AEP supplier portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Texas-New Mexico Power (TNMP)", website: "https://www.tnmp.com/company/suppliers", type: "emc", state: "TX", description: "Smaller T&D utility serving scattered Texas territories — severe thunderstorms, tornadoes, ice storms. Corporate supplier registration (PNM Resources)", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Pedernales Electric Cooperative", website: "https://www.pec.coop/about-us/business-partners", type: "emc", state: "TX", description: "Largest distribution cooperative in Central Texas — severe thunderstorms, tornadoes, flash flooding, ice storms. Business partner information portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Bluebonnet Electric Cooperative", website: "https://www.bluebonnetelectric.coop/company/suppliers", type: "emc", state: "TX", description: "Serves Central Texas region east of Austin — severe thunderstorms, tornadoes, flash flooding. Supplier info via company portal", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
