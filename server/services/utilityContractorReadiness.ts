...
export const NEW_HAMPSHIRE_EMCS: StateEMC[] = [
  { name: "Eversource Energy – New Hampshire", website: "https://www.eversource.com/content/nh/about/doing-business-with-us/suppliers", type: "emc", state: "NH", description: "Largest NH utility (formerly PSNH) serving 500,000+ customers — nor'easters, ice storms, heavy snow, high winds, coastal flooding. Supplier portal with vendor registration, RFPs, and procurement opportunities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance", "Transmission construction"] },
  { name: "Liberty Utilities – New Hampshire", website: "https://new-hampshire.libertyutilities.com", type: "emc", state: "NH", description: "Serves central/southern NH including Keene, Salem, Lebanon — nor'easters, ice storms, heavy snow, high winds. Contact procurement for vendor opportunities", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Unitil Energy Systems – New Hampshire", website: "https://unitil.com/about-us/business-partners", type: "emc", state: "NH", description: "Serves Capital area (Concord) and Seacoast region — nor'easters, ice storms, heavy snow, high winds, coastal flooding. Business partner/vendor information", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "New Hampshire Electric Cooperative (NHEC)", website: "https://www.nhec.com", type: "emc", state: "NH", description: "Only electric cooperative in NH, serves 84,000+ members across rural/mountainous areas — nor'easters, ice storms, heavy snow, high winds, remote terrain. Contact operations for contractor work", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
