...
export const NEBRASKA_EMCS: StateEMC[] = [
  { name: "Dawson Public Power District", website: "https://www.dawsonpower.com", type: "emc", state: "NE", description: "Central NE — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Norris Public Power District", website: "https://www.norrisppd.com", type: "emc", state: "NE", description: "Southeast NE — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cornhusker Public Power District", website: "https://www.cornhuskerpower.com", type: "emc", state: "NE", description: "NE/Columbus area — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Southern Public Power District", website: "https://www.southernpd.com", type: "emc", state: "NE", description: "SE NE/Grand Island — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Elkhorn Rural Public Power District", website: "https://www.erppd.com", type: "emc", state: "NE", description: "NE Nebraska — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Loup Power District", website: "https://www.louppower.com", type: "emc", state: "NE", description: "Central NE — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Cuming County Public Power District", website: "https://www.ccppd.com", type: "emc", state: "NE", description: "NE Nebraska — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Perennial Public Power District", website: "https://www.perennialpower.com", type: "emc", state: "NE", description: "SE Nebraska — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Wheat Belt Public Power District", website: "https://www.wheatbelt.com", type: "emc", state: "NE", description: "Panhandle NE — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Twin Valleys Public Power District", website: "https://www.twinvalleysppd.com", type: "emc", state: "NE", description: "South-central NE — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Vegetation/ROW clearing", "Storm debris removal", "Emergency restoration", "Distribution maintenance"] },
  { name: "Municipal Energy Agency of Nebraska (MEAN)", website: "https://www.nmppenergy.org", type: "support_org", state: "NE", description: "Joint action agency for 70+ NE municipalities — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Nebraska Public Power District (NPPD)", website: "https://www.nppd.com", type: "support_org", state: "NE", description: "Largest public power utility in state — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Omaha Public Power District (OPPD)", website: "https://www.oppd.com/contractors", type: "support_org", state: "NE", description: "Major metropolitan utility — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Lincoln Electric System (LES)", website: "https://www.les.com", type: "support_org", state: "NE", description: "Municipal utility serving Lincoln — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
  { name: "Nebraska Rural Electric Association (NREA)", website: "https://www.nrea.org", type: "support_org", state: "NE", description: "State cooperative association — Tornado Alley, severe thunderstorms, winter blizzards, Great Plains wind events", serviceTypes: ["Storm restoration", "Vegetation management", "Distribution maintenance", "Transmission construction", "Emergency response"] },
];
